...
from domainpy.infrastructure.transcoder import ITranscoder, JsonStr, Message, Record, RecordDict
...
class Mapper(typing.Generic[Message, Record, RecordDict]):
    ...
    def __init__(
        self, 
        transcoder: ITranscoder[Message, Record, RecordDict]
    ):
    ...
    def is_deserializable(self, deserializable: typing.Union[Record, RecordDict, JsonStr]) -> bool:
    ...
    def deserialize(self, deserializable: typing.Union[Record, RecordDict, JsonStr]) -> Message:
        return self.transcoder.deserialize(deserializable, self.map)

    def serialize_asdict(self, message: Message, optimized: bool = False) -> dict:
